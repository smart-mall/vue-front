    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="仓库地址" prop="address">
        <area-select
          ...
          @selected-item="handleAreaSelected"
        />
      </el-form-item>
      <el-form-item label="区域编码" prop="areacode">
        <el-input v-model="dataForm.areacode" placeholder="区域编码" disabled></el-input>
      </el-form-item>
    </el-form>
...
<script>
import AreaSelect from '../common/address-select.vue'
...
export default {
  ...
  methods: {
    ...
    handleAreaSelected (item) {
      this.dataForm.address = item.name
      console.log('选中地区:', item.code, item.name)
    }
  }
}
</script>
