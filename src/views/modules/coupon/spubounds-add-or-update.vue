  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="spuId" prop="spuId">
        <spu-select v-model="dataForm.spuId"></spu-select>
      </el-form-item>
      ...
      <el-form-item label="优惠生效情况" prop="work">
        <work-status-select v-model="dataForm.work"></work-status-select>
      </el-form-item>
    </el-form>
...
<script>
import WorkStatusSelect from '../common/work-status-select.vue'
import SpuSelect from '../common/spu-select.vue'

export default {
  components: {SpuSelect, WorkStatusSelect},
  data () {
    return {
      visible: false,
      dataForm: {
